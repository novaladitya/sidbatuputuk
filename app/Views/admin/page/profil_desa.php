...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Manajemen Konten: Profil Desa</h1>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-12 col-md-6 mb-4">
                    <div class="row">
                        <div class="col-12 col-md-5">
                            <img src="<?= base_url() ?>/assets/img/beranda/post/profil/<?= $p['sampul']; ?>" class="gambar-tabel">
                        </div>
                        <div class="col-12 col-md-7 d-flex">
                            <div class="align-self-center">
                                ...
                                <div class="col-md-12 d-flex">
                                    <div class="mx-auto">
                                        <a type="button" class="fas fa-pencil-alt fa-2x greyiconcolor" href="<?= base_url(); ?>/admin/edit-profil-desa/<?= $p['slug']; ?>#form"></a> &nbsp;&nbsp;&nbsp;
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Yakin menghapus Post Profil Desa?</p>
                    </div>
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?= isset($detailPost) ? 'Edit Post Profil Desa' : 'Tambah Post Profil Desa'; ?></h1>
            </div>
        </div>
    </div>
</section>
...
<section class="content">
    <div class="container-fluid">
        <!-- ======= Tambah Post Profil Desa ======= -->
        <?php if (!isset($detailPost)) : ?>
            <div class="card card-<?= isset($error) ? 'danger' : 'primary'; ?>" id="form">
                <div class="card-header">
                    <h3 class="card-title"><?= isset($error) ? $error['header'] : 'Isi Post Profil di Bawah'; ?></h3>
                </div>

                <?= form_open_multipart(base_url('adminpage/insertprofildesa')); ?>
                <div class="card-body">
        ...
        <?php if (isset($detailPost)) : ?>
            <div class="card card-<?= isset($error) ? 'danger' : 'primary'; ?>" id="form">
                ...
                <?= form_open_multipart(base_url('adminpage/updateprofildesa')); ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="<?= base_url() ?>/assets/img/beranda/post/profil/<?= $detailPost->sampul; ?>" class="gambar-tabel">
                        </div>
...
<script type="text/javascript">
    ...
    deleteModal.addEventListener('show.bs.modal', function(event) {
        ...
        var link = '<?= base_url() ?>/adminpage/deleteprofildesa/' + id;
