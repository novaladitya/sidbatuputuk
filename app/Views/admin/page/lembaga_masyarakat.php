...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Manajemen Konten: Lembaga Masyarakat</h1>
            </div>
        </div>
    </div>
</section>
                ...
                <a type="button" class="card text-white bg-primary" href="#form" style="width: 100%">
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <div class="row text-center">
                            ...
                            <div class="col-12 col-sm-12 col-md-12">
                                <h3>Tambah Post Lembaga Masyarakat</h3>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <div class="col-12 col-md-6 mb-4">
                    <div class="row">
                        <div class="col-12 col-md-5">
                            <img src="<?= base_url() ?>/assets/img/beranda/post/lembagamasyarakat/<?= $p['sampul']; ?>" class="gambar-tabel">
                        </div>
                        <div class="col-12 col-md-7 d-flex">
                            <div class="align-self-center">
                                ...
                                <div class="col-md-12 d-flex">
                                    <div class="mx-auto">
                                        <a type="button" class="fas fa-pencil-alt fa-2x greyiconcolor" href="<?= base_url(); ?>/admin/edit-lembaga-masyarakat/<?= $p['slug']; ?>#form"></a> &nbsp;&nbsp;&nbsp;
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Yakin menghapus Post Lembaga Masyarakat?</p>
                    </div>
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?= isset($detailPost) ? 'Edit Post Lembaga Masyarakat' : 'Tambah Post Lembaga Masyarakat'; ?></h1>
            </div>
        </div>
    </div>
</section>
...
<section class="content">
    <div class="container-fluid">
        <!-- ======= Tambah Post Lembaga Masyarakat ======= -->
        ...
        <?php if (isset($detailPost)) : ?>
            <div class="card card-<?= isset($error) ? 'danger' : 'primary'; ?>" id="form">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="<?= base_url() ?>/assets/img/beranda/post/lembagamasyarakat/<?= $detailPost->sampul; ?>" class="gambar-tabel">
                        </div>
